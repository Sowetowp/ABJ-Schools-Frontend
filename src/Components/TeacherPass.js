...
import { teacher_update_password } from '../Redux/Actions/TeacherAction'
...
const Teacherpass = () => {
    ...
    const submitHandler = (e) => {
        ...
        if (newPassword === newPassword2) {
            dispatch(teacher_update_password(tea))
            setMessage("")
		} else {
                ...
                <div className='col-md-12 mt-3'>
                    <div className='swalfunbs'>
                        <div className='d-flex swalfunaic'>
                            ...
                            <p className='mb-0 ms-2 swalfunp1'>Teacher Account Update</p>
                        </div>
                        <div className='p-3'>
