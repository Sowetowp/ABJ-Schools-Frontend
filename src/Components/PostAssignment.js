...
import { post_assignment } from '../Redux/Actions/TeacherAction'
  ...
  return (
    <>
      <main className='container-fluid shomain'>
        <p className='shopsash2 mb-0'>Assignments</p>
        <p className='swafundpayacc mt-2 mb-0'>Assignments / Post Assignment</p>
        <div className='row'>
          <div className='col-md-12 mt-3'>
            <div className='swalfunbs'>
              <div className='d-flex swalfunaic'>
                <div className='swalfunsbbs'></div>
                <p className='mb-0 ms-2 swalfunp1'>Post Assignment</p>
              </div>
              <div className='p-3'>
                <fieldset className='border swalfunfs px-3 pb-3'>
                  ...
                  <form onSubmit={submitHandler} className='ateafo2'>
                    <h3 className='mt-5 '>Assignment Details</h3>
                    <div className='row'>
