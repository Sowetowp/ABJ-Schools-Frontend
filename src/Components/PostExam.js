...
import bank from "../Assets/Images/exam-svgrepo-com.svg"
...
import { post_assignment, post_exam } from '../Redux/Actions/TeacherAction'
  ...
  return (
    <>
      <main className='container-fluid shomain'>
        <p className='shopsash2 mb-0'>Examination</p>
        <p className='swafundpayacc mt-2 mb-0'>Examination / Post Examination</p>
        <div className='row'>
          <div className='col-md-12 mt-3'>
            <div className='swalfunbs'>
              <div className='d-flex swalfunaic'>
                <div className='swalfunsbbs'></div>
                <p className='mb-0 ms-2 swalfunp1'>Post Examination</p>
              </div>
              <div className='p-3'>
