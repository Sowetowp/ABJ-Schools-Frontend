...
import { parent_update_password } from '../Redux/Actions/ParentAction'
...
const Ppassword = () => {
    ...
    const parentUpdatePassword = useSelector((state) => state.parentUpdatePassword)
	const { loading } = parentUpdatePassword
    ...
    const submitHandler = (e) => {
        ...
        if (newPassword === newPassword2) {
            dispatch(parent_update_password(tea))
            setMessage("")
		} else {
