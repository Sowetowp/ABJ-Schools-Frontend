...
import { student_login } from '../Redux/Actions/StudentAction'
...
const Login2 = () => {
    ...
    const {loading, studentDetail} = studentAuth


    const submitHandler = (e) => {
        e.preventDefault()
        dispatch(student_login(email, password))
    }
    const ViewHandler = () => {
