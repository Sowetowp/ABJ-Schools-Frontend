...
import { parent_login } from '../Redux/Actions/ParentAction'
...
const PLogin = () => {
    ...
    const {loading, parentDetail} = parentAuth


    const submitHandler = (e) => {
        e.preventDefault()
        
        dispatch(parent_login(email, password))
    }
    const ViewHandler = () => {
                ...
                <form className='row' onSubmit={submitHandler}>
                    ...
                    <div className='col-12'>
                        ...
                        <div className='d-flex border-bottom coninputd'>
                            <input className='py-3' placeholder='Password' type='password' id='password' value={password}  onChange={(e) => setPassword(e.target.value)}/>
                            <i
